...
# CLAUDE.md - Bereket Fide Admin Panel

Bu dosya, Claude Code için Bereket Fide Admin Panel projesinde çalışırken izlenmesi gereken kurallar ve standartları içerir.

## 📋 Proje Genel Bakış

**Bereket Fide Admin Panel** - Next.js 16 tabanlı, dinamik tema desteği olan modern admin yönetim paneli.
