...
export default function AdminServicesClient() {
  ...
  function onCreate() {
    router.push(`/services/new?locale=${encodeURIComponent(effectiveLocale || 'tr')}`);
  }
                    ...
                    <TableRow key={id}>
                      ...
                      <TableCell className="text-right">
                        <div className="inline-flex items-center gap-2">
                          <Button variant="outline" size="sm" onClick={() => router.push(`/services/${encodeURIComponent(id)}?locale=${encodeURIComponent(effectiveLocale || 'tr')}`)} disabled={busy || !isValidId(id)}>
