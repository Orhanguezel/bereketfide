...
function labelOfModuleKey(k: string, t: any) {
  const map: Record<string, string> = {
    ...
    bereketfide_blog: t('admin.customPage.moduleLabels.bereketfide_blog'),
    bereketfide_about: t('admin.customPage.moduleLabels.bereketfide_about'),
    bereketfide_legal: t('admin.customPage.moduleLabels.bereketfide_legal'),
  ...
  return (
    <div className="min-w-0 w-full max-w-full overflow-hidden space-y-4">
      <CustomPageHeader
        ...
        newPageHref={
          filters.moduleKey
            ? `/custompage/new?module=${encodeURIComponent(filters.moduleKey)}`
            : '/custompage/new'
        }
      />
