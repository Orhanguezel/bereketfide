...
import { AppSidebar } from '@/app/(main)/(admin-pages)/_components/sidebar/app-sidebar';
            ...
            >
              <div className="flex w-full items-center justify-between px-4 lg:px-6">
                <div className="flex items-center gap-1 lg:gap-2">
                  ...
                  />
                  <h2 className="text-sm font-semibold tracking-tight hidden sm:block">Bereket Fide Admin</h2>
                </div>
