...
import { OfferPdfPreview } from '@/app/(main)/admin/(admin)/offer/_components/offer-pdf-preview';
  ...
  async function handleSubmit() {
    try {
      ...
      if (isNew) {
        ...
        if (created?.id) router.replace(`/admin/library/${created.id}?locale=${effectiveLocale}`);
      } else {
