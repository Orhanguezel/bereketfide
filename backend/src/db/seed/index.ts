...
function parseFlags(argv: string[]): Flags {
  ...
  for (const a of argv.slice(2)) {
    if (a === '--no-drop') flags.noDrop = true;
      ...
      if (profile === 'bereketfide') flags.profile = 'bereketfide';
    }
  }
  return flags;
}
...
const PROFILE_PREFIXES: Record<NonNullable<Flags['profile']>, string[]> = {
  bereketfide: [
    ...
    '030', '031', '032',
    '040', '041', '042', '043', '044', '045', '046',  // site_settings + admin config + storage + theme + logos + hero + seo
    '050', '060', '070', '080', '090', '095',
    '100', '110', '120', '130', '131', '140', '150', '160', '170', '180', '190',
    '200', '201', '220', '230', '240', '241',
    // ── Bereket Fide'a özgü veri dosyaları ───────────────────────────────
    '299', '300', '301', '302', '303', '304', '305', '306', '307', '308', '309', '310', '311', '312', '313',
    '314', '315', '316', '317', '319', '320', '321',
