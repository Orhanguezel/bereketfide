...
-- Bereket Fide Kurumsal Sayfaları – Misyon
...
(
  ...
  'Bereket Fide''in sektörde yenilikçi, verimli ve ekonomik su soğutma kuleleri çözümleri sunma hedefini tanımlar.',
  'Misyonumuz - Bereket Fide Su Soğutma Kuleleri',
  'Misyonumuz | Bereket Fide Su Soğutma Kuleleri',
  'Sektördeki yenilikleri takip ederek su soğutma kulelerinde en iyi çözümleri sunmayı hedefleyen Bereket Fide''in misyonu.',
  'bereketfide,misyon,su sogutma kuleleri,frp',
  NOW(3),
  NOW(3)
),
-- EN
(
  ...
  'Describes Bereket Fide''s mission to provide efficient and economical water cooling tower solutions worldwide.',
  'Our Mission - Bereket Fide Water Cooling Towers',
  'Our Mission | Bereket Fide Water Cooling Towers',
  'Bereket Fide''s mission is to follow innovations and provide efficient, economical water cooling tower solutions tailored to customer needs.',
  'bereketfide,mission,water cooling towers,frp',
  NOW(3),
  NOW(3)
),
-- DE
(
  ...
  'Beschreibt Bereket Fides Mission, effiziente und wirtschaftliche Wasserkühlturm-Lösungen anzubieten und zu den führenden Anbietern zu zählen.',
  'Unsere Mission – Bereket Fide Wasserkühltürme',
  'Unsere Mission | Bereket Fide Wasserkühltürme',
  'Bereket Fides Mission: Innovationen verfolgen und kundenorientierte, effiziente sowie wirtschaftliche Wasserkühlturm-Lösungen bereitstellen.',
  'bereketfide,mission,wasserkühltürme,frp',
  NOW(3),
  NOW(3)
)
ON DUPLICATE KEY UPDATE
