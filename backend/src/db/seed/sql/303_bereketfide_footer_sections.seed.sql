...
-- Bereket Fide — footer sections (TR/EN)
-- site_id = 'bereketfide'
-- =============================================================
...
VALUES
-- Hızlı Erişim
('ee010001-4001-4001-8001-ee0000000001', 'bereketfide', 1, 0, NOW(3), NOW(3)),
-- Yasal
('ee010002-4002-4002-8002-ee0000000002', 'bereketfide', 1, 1, NOW(3), NOW(3)),
-- Sosyal
('ee010003-4003-4003-8003-ee0000000003', 'bereketfide', 1, 2, NOW(3), NOW(3))
