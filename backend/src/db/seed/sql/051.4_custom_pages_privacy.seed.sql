...
-- Bereket Fide – Custom Page: Privacy Policy (TR/EN/DE)
...
(
    ...
    CONCAT(
      '<section class="container mx-auto px-4 py-10">',
        ...
        '<p class="text-slate-700 mb-8">',
          'Bereket Fide olarak, web sitemizi ziyaret eden kullanıcılarımızın gizliliğini korumayı ve kişisel verileri yürürlükteki mevzuata uygun şekilde işlemeyi taahhüt ederiz. ',
  ...
  'Bereket Fide Gizlilik Politikası: web sitesinde toplanan veriler, kullanım amaçları, saklama, güvenlik ve kullanıcı hakları hakkında bilgilendirme.',
  'Bereket Fide Gizlilik Politikası sayfası',
  'Gizlilik Politikası | Bereket Fide',
  'Bereket Fide Gizlilik Politikası; toplanan veriler, işleme amaçları, saklama ve güvenlik önlemleri ile kullanıcı hakları hakkında bilgilendirir.',
  'bereketfide,kurumsal,gizlilik politikası,veri güvenliği,kvkk,çerezler',
  NOW(3),
  NOW(3)
),
...
(
  ...
  JSON_OBJECT(
    ...
    CONCAT(
      '<section class="container mx-auto px-4 py-10">',
        ...
        '<p class="text-slate-700 mb-8">',
          'At Bereket Fide, we are committed to protecting the privacy of visitors and processing personal data in compliance with applicable laws. ',
  ...
  'Bereket Fide Privacy Policy: data collected on the website, purposes of processing, retention, security and user rights.',
  'Bereket Fide Privacy Policy page',
  'Privacy Policy | Bereket Fide',
  'Bereket Fide Privacy Policy explains what data we collect, why we process it, how we protect it, and what rights users have.',
  'bereketfide,corporate,privacy policy,data protection,cookies,security',
  NOW(3),
  NOW(3)
),
...
(
  ...
  JSON_OBJECT(
    ...
    CONCAT(
      '<section class="container mx-auto px-4 py-10">',
        ...
        '<p class="text-slate-700 mb-8">',
          'Bereket Fide verpflichtet sich, die Privatsphäre der Besucher zu schützen und personenbezogene Daten im Einklang mit den anwendbaren gesetzlichen Vorgaben zu verarbeiten. ',
  ...
  'Bereket Fide Datenschutzerklärung: Datenkategorien, Zwecke, Aufbewahrung, Sicherheitsmaßnahmen und Rechte der Nutzer.',
  'Bereket Fide Datenschutzerklärung',
  'Datenschutzerklärung | Bereket Fide',
  'Die Bereket Fide Datenschutzerklärung erläutert, welche Daten wir erheben, wofür wir sie verwenden, wie wir sie schützen und welche Rechte Nutzer haben.',
  'bereketfide,unternehmen,datenschutz,cookies,sicherheit,personenbezogene daten',
  NOW(3),
  NOW(3)
)
ON DUPLICATE KEY UPDATE
