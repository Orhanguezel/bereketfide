...
-- KONU: Bereket Fide – Soğutma Kuleleri (Cooling Towers)
-- MODEL:
--   - reviews: parent
...
VALUES
  ...
  ('44440001-4444-4444-8444-444444441001', @REV_MISSION, 'tr',
   ...
   'Bereket Fide''in misyon açıklaması, sektöre bakışını ve müşteri odaklı yaklaşımını çok net şekilde ortaya koyuyor.',
   NULL, NOW(3), NOW(3)),
  ('44440001-4444-4444-8444-444444441002', @REV_MISSION, 'en',
   'Strong customer-oriented mission',
   'I really like how Bereket Fide puts customer satisfaction and efficiency at the center of its mission.',
   NULL, NOW(3), NOW(3)),
  ...
  ('44440003-4444-4444-8444-444444443002', @REV_ABOUT, 'en',
   ...
   'The about page gives a very clear picture of Bereket Fide''s long-term experience and strong reference projects.',
   NULL, NOW(3), NOW(3)),
  ('44440003-4444-4444-8444-444444443003', @REV_ABOUT, 'de',
   'Sehr überzeugender Unternehmenshintergrund',
   'Die „Über uns“-Seite vermittelt einen klaren Eindruck von Bereket Fides Erfahrung und den starken Referenzprojekten.',
   NULL, NOW(3), NOW(3)),
