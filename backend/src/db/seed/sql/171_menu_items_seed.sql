...
-- Bereket Fide – Header + Footer (FINAL, no inactive)
-- Standard:
...
(UUID(),'7b000002-1111-4111-8111-7b0000000002','tr','Kule Özellikleri','/library/bereketfide-sogutma-kulelerinin-ozellikleri','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
...
-- FOOTER: SOCIAL (TR)
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-111111111111','tr','LinkedIn','https://www.linkedin.com/company/bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-222222222222','tr','Instagram','https://www.instagram.com/bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-333333333333','tr','YouTube','https://www.youtube.com/@bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-444444444444','tr','X','https://x.com/bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000')
ON DUPLICATE KEY UPDATE
  `title`      = VALUES(`title`),
  `url`        = VALUES(`url`),
  `updated_at` = CURRENT_TIMESTAMP(3);
...
(UUID(),'7b000002-1111-4111-8111-7b0000000002','en','Tower Features','/library/features-of-bereketfide-cooling-towers','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
...
-- FOOTER: SOCIAL (EN)
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-111111111111','en','LinkedIn','https://www.linkedin.com/company/bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-222222222222','en','Instagram','https://www.instagram.com/bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-333333333333','en','YouTube','https://www.youtube.com/@bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-444444444444','en','X','https://x.com/bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000')
ON DUPLICATE KEY UPDATE
  `title`      = VALUES(`title`),
  `url`        = VALUES(`url`),
  `updated_at` = CURRENT_TIMESTAMP(3);
...
(UUID(),'7b000002-1111-4111-8111-7b0000000002','de','Eigenschaften','/library/merkmale-der-bereketfide-kuehltuerme','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
...
-- FOOTER: SOCIAL (DE)
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-111111111111','de','LinkedIn','https://www.linkedin.com/company/bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-222222222222','de','Instagram','https://www.instagram.com/bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-333333333333','de','YouTube','https://www.youtube.com/@bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000'),
(UUID(),'a9b1c2d3-e4f5-4a66-8b11-444444444444','de','X','https://x.com/bereketfide','2024-01-01 00:00:00.000','2024-01-01 00:00:00.000')
ON DUPLICATE KEY UPDATE
  `title`      = VALUES(`title`),
  `url`        = VALUES(`url`),
  `updated_at` = CURRENT_TIMESTAMP(3);
...
UPDATE `menu_items_i18n` SET `url` = '/about/bereketfide-su-sogutma-kuleleri',                   `updated_at` = CURRENT_TIMESTAMP(3) WHERE `menu_item_id` = 'aaaa1111-2222-3333-4444-555555555555' AND `locale` = 'tr' AND `url` = '/about';
UPDATE `menu_items_i18n` SET `url` = '/about/bereketfide-water-cooling-towers',                  `updated_at` = CURRENT_TIMESTAMP(3) WHERE `menu_item_id` = 'aaaa1111-2222-3333-4444-555555555555' AND `locale` = 'en' AND `url` = '/about';
UPDATE `menu_items_i18n` SET `url` = '/about/bereketfide-wasserkuehltuerme',                     `updated_at` = CURRENT_TIMESTAMP(3) WHERE `menu_item_id` = 'aaaa1111-2222-3333-4444-555555555555' AND `locale` = 'de' AND `url` = '/about';
