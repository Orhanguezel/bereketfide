...
-- Bereket Fide – Custom Page: KVKK (TR/EN/DE)
...
(
    ...
    CONCAT(
      '<section class="container mx-auto px-4 py-10">',
        ...
        '<p class="text-slate-700 mb-8">',
          'Bereket Fide, 6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK) kapsamında kişisel verilerin işlenmesi ve korunmasına önem verir. ',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700">',
            'Kişisel verileriniz, veri sorumlusu sıfatıyla Bereket Fide tarafından KVKK ve ilgili mevzuata uygun olarak işlenebilir.',
          '</p>',
        '</div>',
  ...
  'Bereket Fide KVKK sayfası: 6698 sayılı kanun kapsamında veri işleme ve ilgili kişi haklarına ilişkin genel bilgilendirme.',
  'Bereket Fide KVKK bilgilendirme sayfası',
  'KVKK | Bereket Fide',
  'Bereket Fide KVKK bilgilendirmesi: kişisel verilerin işlenmesi, hukuki sebepler, güvenlik önlemleri ve başvuru hakları.',
  'bereketfide,legal,kvkk,kisisel veri,veri guvenligi,aydinlatma',
  NOW(3), NOW(3)
),
(
  ...
  JSON_OBJECT(
    ...
    CONCAT(
      '<section class="container mx-auto px-4 py-10">',
        ...
        '<p class="text-slate-700 mb-8">',
          'Bereket Fide processes and protects personal data in accordance with Turkish PDPL (KVKK No. 6698) and applicable regulations. ',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700">Bereket Fide may process personal data as the data controller in line with applicable laws.</p>',
        '</div>',
        '<div class="grid md:grid-cols-2 gap-6 mb-6">',
          '<div class="bg-white border border-slate-200 rounded-2xl p-6">',
  ...
  'Bereket Fide PDPL/KVKK overview: data categories, purposes, legal grounds and rights.',
  'Bereket Fide PDPL/KVKK notice page',
  'PDPL (KVKK) | Bereket Fide',
  'Bereket Fide PDPL/KVKK overview covering processing purposes, legal grounds, security measures and data subject rights.',
  'bereketfide,legal,pdpl,kvkk,personal data,data protection',
  NOW(3), NOW(3)
),
(
  ...
  JSON_OBJECT(
    ...
    CONCAT(
      '<section class="container mx-auto px-4 py-10">',
        ...
        '<p class="text-slate-700 mb-8">',
          'Bereket Fide verarbeitet personenbezogene Daten im Einklang mit den anwendbaren gesetzlichen Vorgaben (u. a. DSGVO/KVKK-Kontext). ',
        ...
        '<div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6">',
          ...
          '<p class="text-slate-700">Bereket Fide kann personenbezogene Daten als Verantwortlicher rechtskonform verarbeiten.</p>',
        '</div>',
        '<div class="grid md:grid-cols-2 gap-6 mb-6">',
          '<div class="bg-white border border-slate-200 rounded-2xl p-6">',
  ...
  'Bereket Fide DSGVO/KVKK Übersicht: Datenkategorien, Zwecke, Rechtsgrundlagen und Rechte.',
  'Bereket Fide DSGVO/KVKK Hinweis',
  'DSGVO / KVKK | Bereket Fide',
  'Übersicht zu personenbezogenen Daten bei Bereket Fide: Verarbeitung, Rechtsgrundlagen, Sicherheitsmaßnahmen und Betroffenenrechte.',
  'bereketfide,legal,datenschutz,dsgvo,kvkk,personenbezogene daten',
  NOW(3), NOW(3)
)
ON DUPLICATE KEY UPDATE
  -- NOTE: image fields intentionally omitted — admin changes must not be overwritten by re-seeding
