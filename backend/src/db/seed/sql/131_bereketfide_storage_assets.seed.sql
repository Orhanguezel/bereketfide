...
VALUES
  ...
  ('bf-brand-img-0011', NULL, 'vistaseeds.jpeg',            'brand_references', 'brand_references/vistaseeds.jpeg',            'brand_references', 'image/jpeg', 33281,  992, 581, '/uploads/brand_references/vistaseeds.jpeg',            NULL, 'local', 'brand_references/vistaseeds.jpeg',            'image', 'jpeg', NULL, NULL, '{}', NOW(), NOW())
ON DUPLICATE KEY UPDATE
  url = VALUES(url),
  size = VALUES(size),
  width = VALUES(width),
