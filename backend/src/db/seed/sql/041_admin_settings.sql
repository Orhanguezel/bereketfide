...
-- =============================================================
-- FILE: 041_admin_settings.sql (Bereket Fide)
...
(
  ...
  CAST(JSON_OBJECT(
    ...
    'branding', JSON_OBJECT(
      ...
      'app_copyright', 'Bereket Fide GmbH',
      'html_lang', 'de',
      'theme_color', '#0066CC',
      ...
      'meta', JSON_OBJECT(
        'title', 'Bereket Fide - Industrielle Kühl- und Klimatechnik | HVAC Lösungen',
        'description', 'Bereket Fide: Führender Anbieter für industrielle Kühl- und Klimatechnik. Adiabate Kühlung, Verdunstungskühler und maßgeschneiderte HVAC-Lösungen für Industrie und Gewerbe.',
        'og_url', 'https://bereketfide.de/',
        'og_title', 'Bereket Fide - Industrielle Kühl- und Klimatechnik',
        ...
        'og_image', '/logo/bereketfide-logo.svg',
