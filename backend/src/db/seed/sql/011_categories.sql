...
-- Bereket Fide – Categories seed + category_i18n (TR/EN/DE)
--
-- Özellikler:
...
VALUES
  ...
  ('aaaa2004-1111-4111-8111-aaaaaaaa2004','tr','BASINDA Bereket Fide','basinda-bereketfide',NULL,NULL),
  ...
  ('aaaa2004-1111-4111-8111-aaaaaaaa2004','en','Bereket Fide in the Media','bereketfide-in-the-media',NULL,NULL),
  ...
  ('aaaa2004-1111-4111-8111-aaaaaaaa2004','de','Bereket Fide IN DEN MEDIEN','bereketfide-in-den-medien',NULL,NULL),
  ...
  ('aaaa8001-1111-4111-8111-aaaaaaaa8001','tr','HİZMETLER','hizmetler',
    'Bereket Fide, su soğutma kuleleri için bakım ve onarım, modernizasyon, yedek parça tedariki, uygulamalar ve mühendislik desteği sunar.',
    NULL
  ),
  ('aaaa8001-1111-4111-8111-aaaaaaaa8001','en','Services','services',
    'Bereket Fide provides maintenance and repair, modernization, spare parts, applications and engineering support for industrial cooling towers.',
    NULL
  ),
  ('aaaa8001-1111-4111-8111-aaaaaaaa8001','de','DIENSTLEISTUNGEN','dienstleistungen',
    'Bereket Fide bietet Wartung und Reparatur, Modernisierung, Ersatzteile, Anwendungen und Engineering-Support für industrielle Kühltürme.',
    NULL
  ),
  ...
  ('aaaa9101-1111-4111-8111-aaaaaaaa9101','tr','EKİBİMİZ','ekibimiz',
    'Bereket Fide mühendislik, proje, saha ve servis ekiplerinden oluşan uzman kadromuz.',
    NULL
  ),
  ('aaaa9101-1111-4111-8111-aaaaaaaa9101','en','Our Team','our-team',
    'Our expert team consisting of engineering, project, field and service professionals at Bereket Fide.',
    NULL
  ),
  ('aaaa9101-1111-4111-8111-aaaaaaaa9101','de','UNSER TEAM','unser-team',
    'Unser Expertenteam bei Bereket Fide besteht aus Fachkräften aus Engineering, Projektleitung, Außendienst und Service.',
    NULL
  )
ON DUPLICATE KEY UPDATE
  `name`        = VALUES(`name`),
