...
-- Bereket Fide – Offers Seed Data (test/demo)
-- =============================================================
...
(
  ...
  NULL, NULL,
  '{"relatedType":"sparepart","existingTower":"Bereket Fide CTP-150 (2019)","notes":"Acil ihtiyaç, 2 hafta içinde teslimat bekleniyor."}',
  1, 1,
...
(
  ...
  'Wir möchten einen jährlichen Wartungsvertrag für unseren bestehenden Bereket Fide-Kühlturm abschließen.',
  NULL, '90000001-1111-4111-8111-900000000001',
  '{"relatedType":"service","serviceName":"Wartung & Reparatur","existingTower":"Bereket Fide DCTP-200 (2021)","city":"Wien","referralSource":"Messe Aquatherm"}',
  1, 1,
