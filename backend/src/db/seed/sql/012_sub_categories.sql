...
-- Bereket Fide – Sub Categories schema + seed (TR/EN/DE)
...
VALUES
  ...
  ('bbbb7004-1111-4111-8111-bbbbbbbb7004','tr','Kalite & Sertifikalar','kalite-sertifikalar','Bereket Fide kalite yönetim yaklaşımı ve uluslararası sertifikalarımız.',NULL),
  ...
  ('bbbb7004-1111-4111-8111-bbbbbbbb7004','en','Quality & Certificates','quality-certificates','Bereket Fide quality management approach and internationally recognised certificates.',NULL),
  ...
  ('bbbb7004-1111-4111-8111-bbbbbbbb7004','de','Qualität & Zertifikate','qualitaet-zertifikate','Bereket Fide Qualitätsmanagement-Ansatz und international anerkannte Zertifikate.',NULL),

  -- ==========================================================
  -- LEGAL (YASAL & KVKK – aaaa7101)
  -- ==========================================================
  ('bbbb7005-1111-4111-8111-bbbbbbbb7005','tr','Gizlilik Politikası','gizlilik-politikasi','Bereket Fide gizlilik politikası ve kişisel verilerin korunmasına ilişkin yaklaşım.',NULL),
  ...
  ('bbbb7005-1111-4111-8111-bbbbbbbb7005','en','Privacy Policy','privacy-policy','Bereket Fide privacy policy and approach to protecting personal data.',NULL),
  ...
  ('bbbb7005-1111-4111-8111-bbbbbbbb7005','de','Datenschutzerklärung','datenschutzerklaerung','Bereket Fide Datenschutzerklärung und Ansatz zum Schutz personenbezogener Daten.',NULL),
  ...
  -- ==========================================================
  ('bbbb8001-1111-4111-8111-bbbbbbbb8001','tr','Üretim','uretim','Bereket Fide, endüstriyel su soğutma kuleleri üretiminde uzmandır. Açık ve kapalı devre FRP (cam elyaf takviyeli polyester) malzemeden, dayanıklı, uzun ömürlü ve yüksek kaliteli soğutma kuleleri üretir.',NULL),
  ('bbbb8002-1111-4111-8111-bbbbbbbb8002','tr','Bakım ve Onarım','bakim-ve-onarim','Bereket Fide, endüstriyel su soğutma kulelerinizin sorunsuz çalışmasını sağlamak amacıyla periyodik bakım ve profesyonel onarım hizmetleri sunar. Deneyimli ekibimiz ile sistemlerinizin ömrünü uzatır ve performans kaybını önleriz. Mevcut soğutma kulelerinin verimliliğini sağlamak için düzenli bakım ve onarım hizmetleri sunuyoruz.',NULL),
  ('bbbb8003-1111-4111-8111-bbbbbbbb8003','tr','Modernizasyon','modernizasyon','Bereket Fide, mevcut su soğutma kulelerinin daha verimli ve güncel standartlara uygun çalışabilmesi için modernizasyon çözümleri sunar. Eskiyen sistemlerinizi daha düşük maliyetle yenilemek ve enerji verimliliğini artırmak mümkündür. Eski soğutma kulelerinin performansını artırmak için modernizasyon hizmetleri sunuyoruz.',NULL),
  ('bbbb8004-1111-4111-8111-bbbbbbbb8004','tr','Yedek Parçalar ve Bileşenler','yedek-parcalar-ve-bilesenler','Bereket Fide, su soğutma kuleleri için geniş bir yedek parça ve bileşen portföyü sunar. Tüm yedek parçalarımız, kulelerinizin uzun ömürlü ve verimli çalışması için kaliteli ve güvenilirdir. Soğutma kulelerinin sorunsuz çalışmasını sağlamak için geniş yedek parça ve bileşen seçenekleri sunuyoruz.',NULL),
  ('bbbb8005-1111-4111-8111-bbbbbbbb8005','tr','Uygulamalar ve Referanslar','uygulamalar-ve-referanslar','Bereket Fide, endüstriyel ve ticari alanlarda çok sayıda referans projeye ve uygulamaya sahiptir. Enerji, kimya, gıda, ilaç, otomotiv ve daha birçok sektörde su soğutma kuleleriyle yerli ve yabancı yüzlerce projeye çözüm sunmuştur. Deneyimimiz ve uzman ekibimiz sayesinde müşterilerimizin farklı ihtiyaçlarına uygun, uzun ömürlü ve verimli soğutma sistemleri sağlıyoruz. Referanslarımız ve uygulama örneklerimiz, yüksek kalite ve güvenin göstergesidir.',NULL),
  ('bbbb8006-1111-4111-8111-bbbbbbbb8006','tr','Mühendislik Desteği','muhendislik-destegi','Bereket Fide, projelendirme, danışmanlık, sistem optimizasyonu, performans analizi ve teknik eğitim dahil olmak üzere kapsamlı mühendislik destek hizmetleri sağlar. Uzman mühendislerimiz, projelerin tasarımından devreye alınmasına kadar her aşamada müşterilerimizin yanında olur. En iyi verim, düşük maliyet ve uzun ömürlü çözümler için profesyonel destek sunuyoruz. Bereket Fide, müşterilerine soğutma kuleleri alanında uzman mühendislik desteği sunar.',NULL),

  ('bbbb8001-1111-4111-8111-bbbbbbbb8001','en','Production','production','Bereket Fide is specialized in manufacturing industrial water cooling towers. The production covers durable, long life open and closed circuit FRP cooling towers with high quality standards.',NULL),
  ('bbbb8002-1111-4111-8111-bbbbbbbb8002','en','Maintenance & Repair','maintenance-and-repair','Bereket Fide provides periodic maintenance and professional repair services for industrial water cooling towers, extending system lifetime and preserving performance and efficiency.',NULL),
  ('bbbb8003-1111-4111-8111-bbbbbbbb8003','en','Modernization','modernization','Bereket Fide offers modernization solutions to bring existing cooling towers up to current efficiency and performance standards, increasing energy efficiency with lower investment costs.',NULL),
  ('bbbb8004-1111-4111-8111-bbbbbbbb8004','en','Spare Parts & Components','spare-parts-and-components','Bereket Fide supplies a wide portfolio of spare parts and components for cooling towers, ensuring reliable, long life and efficient operation of your systems.',NULL),
  ('bbbb8005-1111-4111-8111-bbbbbbbb8005','en','Applications & References','applications-and-references','Bereket Fide has many reference projects and applications in industrial and commercial fields, delivering long life and efficient cooling tower solutions for energy, chemical, food, pharmaceutical, automotive and many other sectors.',NULL),
  ('bbbb8006-1111-4111-8111-bbbbbbbb8006','en','Engineering Support','engineering-support','Bereket Fide provides comprehensive engineering support for cooling tower projects, including design, consulting, system optimisation, performance analysis and technical training from concept to commissioning.',NULL),

  ('bbbb8001-1111-4111-8111-bbbbbbbb8001','de','Produktion','produktion','Bereket Fide ist spezialisiert auf die Herstellung industrieller Wasserkühltürme. Wir produzieren langlebige, hochwertige offene und geschlossene FRP-Kühltürme nach hohen Qualitätsstandards.',NULL),
  ('bbbb8002-1111-4111-8111-bbbbbbbb8002','de','Wartung & Reparatur','wartung-reparatur','Bereket Fide bietet regelmäßige Wartung und professionelle Reparatur für industrielle Wasserkühltürme, verlängert die Lebensdauer der Systeme und verhindert Leistungs- und Effizienzverluste.',NULL),
  ('bbbb8003-1111-4111-8111-bbbbbbbb8003','de','Modernisierung','modernisierung','Bereket Fide bietet Modernisierungslösungen, um bestehende Kühltürme auf aktuelle Effizienz- und Leistungsstandards zu bringen und die Energieeffizienz mit geringeren Investitionskosten zu steigern.',NULL),
  ('bbbb8004-1111-4111-8111-bbbbbbbb8004','de','Ersatzteile & Komponenten','ersatzteile-komponenten','Bereket Fide liefert ein breites Portfolio an Ersatzteilen und Komponenten für Kühltürme und gewährleistet einen zuverlässigen, langlebigen und effizienten Betrieb Ihrer Anlagen.',NULL),
  ('bbbb8005-1111-4111-8111-bbbbbbbb8005','de','Anwendungen & Referenzen','anwendungen-referenzen','Bereket Fide verfügt über zahlreiche Referenzprojekte in Industrie und Gewerbe und liefert langlebige, effiziente Kühlturmlösungen für Energie, Chemie, Lebensmittel, Pharma, Automotive und weitere Branchen.',NULL),
  ('bbbb8006-1111-4111-8111-bbbbbbbb8006','de','Engineering-Support','engineering-support','Bereket Fide bietet umfassenden Engineering-Support für Kühlturmprojekte – von Auslegung und Beratung über Systemoptimierung und Performance-Analyse bis hin zu Schulungen und Inbetriebnahme.',NULL),
