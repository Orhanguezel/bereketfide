...
-- Bereket Fide Kurumsal Sayfaları – Vizyon
...
(
  ...
  'Bereket Fide vizyonu: sürdürülebilir kalite ve güvenilir marka yaklaşımı.',
  NULL,
  'Vizyonumuz | Bereket Fide',
  'Müşteri memnuniyetini merkeze alan, sürdürülebilir kalite anlayışıyla hareket eden Bereket Fide vizyonu.',
  'bereketfide,vizyon,surdurulebilir,kalite',
  NOW(3),
  NOW(3)
),
...
(
  ...
  'Bereket Fide vision: sustainable quality and trusted brand approach.',
  NULL,
  'Our Vision | Bereket Fide',
  'Bereket Fide’s vision: customer-first approach with sustainable quality and leadership.',
  'bereketfide,vision,sustainable,quality',
  NOW(3),
  NOW(3)
),
...
(
  ...
  'Bereket Fide Vision: nachhaltige Qualität und verlässlicher Markenansatz.',
  NULL,
  'Unsere Vision | Bereket Fide',
  'Bereket Fides Vision: kundenorientiert, nachhaltig und führend – mit Fokus auf Qualität.',
  'bereketfide,vision,nachhaltig,qualität',
  NOW(3),
  NOW(3)
)
ON DUPLICATE KEY UPDATE
