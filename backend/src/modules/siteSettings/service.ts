...
// Bereket Fide – SiteSettings Service (FINAL)
// Key points:
...
/**
 * ✅ TELEGRAM KEYS (Bereket Fide)
 * Base settings + event flags + templates for Bereket Fide business flows
 */
const TELEGRAM_KEYS = [
  // Base settings
  ...
  // Event flags - Bereket Fide specific
  ...
  // Event templates - Bereket Fide specific
...
/**
 * Bereket Fide için pratik preferred fallback.
