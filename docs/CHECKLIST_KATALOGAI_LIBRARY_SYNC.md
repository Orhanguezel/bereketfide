...
- [projects/katalogAI/backend/src/modules/catalogs/schema.ts](../katalogAI/backend/src/modules/catalogs/schema.ts)
- [projects/katalogAI/backend/src/modules/catalogs/admin.controller.ts](../katalogAI/backend/src/modules/catalogs/admin.controller.ts)
- [projects/katalogAI/backend/src/modules/exports/publish-service.ts](../katalogAI/backend/src/modules/exports/publish-service.ts)
- [projects/katalogAI/admin_panel/src/app/(main)/admin/(admin)/catalogs/_components/catalog-create-dialog.tsx](../katalogAI/admin_panel/src/app/(main)/admin/(admin)/catalogs/_components/catalog-create-dialog.tsx)
- [packages/shared-backend/modules/library/schema.ts](../../packages/shared-backend/modules/library/schema.ts)
- [projects/bereketfide/CHECKLIST_KATALOG_ENTEGRASYONU.md](CHECKLIST_KATALOG_ENTEGRASYONU.md) — bu dosyanın öncüsü (kapanmış durum belgesi)
